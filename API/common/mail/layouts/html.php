...
<html xmlns="http://www.w3.org/1999/xhtml"
    style="font-family: sans-serif; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;">
...
<head>
    ...
    <style type="text/css"
        data-styled-components="iECmZH gilyel evpGNr byGfxM jFgvCd kktUDF jlPFGn eWjzRU jGqJlD kuqIKy ktKmOq iWVBpY hNogKD dggHpc jpHwD ipliua doYTvo eLCXzP hznfox cHZARy fhbjHj dRtAmU cULmEo hiKSiS cpoSvg kSOdgB GrYpZ dRiOjk cKjbEQ CLluW irjKNI dDRnsI YzqzA gEwPsy gLRoTZ bTVPzW eLBKpU bXYmZq jiDMyE cCPdDf kFuKSG JaVau iheQPW cDBKQv fKsNLk eRGRqS efxxAa eMaSBg fVrZls evjDXW bqVLhR gXwWwO etWFLc jhTbHC hRkhrw gEMvbe dJvZEL dBSBrt fJDlWs chprFS bxIgtu dQWvvR llGlaf cTengc idjmuw"
...
<body
    style="min-width: 320px; background-color: #FFFFFF; width: 100%; margin: 0; padding: 0; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
    <?php $this->beginBody()?>
            ...
            <tr>
                <td align="center" valign="top" style="padding: 0;">
                    <table width="600" align="center" cellpadding="0" cellspacing="0"
                        style="border-collapse: collapse; border-spacing: 0; background-color: #F3F4F5; text-align: center;"
                        border="0" valign="top" bgcolor="#F3F4F5">
                        <tbody>
                            <tr>
                                <td style="padding: 0;">
                                    <div class="sc-bdVaJa gilyel" display="block"
                                        ...
                                        <img class="sc-bwzfXH evpGNr"
                                            src="<?=Url::base() . '/../img_assets/fan-rating.png'?>" alt="Eternity"
                                            width="20" style="border: 0; width: 10rem;">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 0;">
                                    <div class="sc-bdVaJa byGfxM" display="block"
                                        ...
                                        <span class="sc-bxivhb jFgvCd" color="gray1" scale="1"
                                            ...
                                            <div class="sc-kgoBCf kktUDF" overflow="hidden"
                                                style="border-top: none; border-bottom: none; border-left: none; border-right: none; border-radius: 0; box-shadow: 0 2px 0 0 rgba(5, 45, 73, 0.06999999999999995); background-color: #FFFFFF; overflow: hidden;">
                                                <div class="sc-bdVaJa jlPFGn" display="block"
