...
/* @var $searchModel common\models\UserLevelListSearch */
        ...
        <?php echo Yii::$app->general->getFlash(); ?>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    'point',
                    [
                        'attribute' => 'level_price',
                        'format' => 'raw',
                        'value' => function ($model) {
                            return Yii::$app->formatter->asCurrency($model->level_price);
                        },
                    ],
                    'description',
