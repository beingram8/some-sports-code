    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model) {
                return '<button type="button" class="btn btn-primary btn-sm open_html_modal" data-id="' . $model->html_body . '" data-toggle="modal" >
                                                View Html Body
                                            </button>';
            },
        ],
...
<div class="modal fade" id="html-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Html Description</h5>
