        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header pl-0 pb-0 mb-10">
                    <h3 class="card-title m-0 mb-3"><?=Yii::t('app', 'Survey Form');?></h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <?=$form->field($model, 'sponsored_by')->textInput(['maxlength' => true])?>
                    </div>
    ...
    'options' => [
        'autocomplete' => "off",
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <?php echo $form->field($model, 'sponsor_adv')
                            ->widget(\budyaga\cropper\Widget::className(), [
                                'uploadUrl' => \yii\helpers\Url::toRoute('/image/upload?s3_folder=survey'),
                                'width' => 300,
                                'height' => 150,
                                'maxSize' => 10000 * 1000,
