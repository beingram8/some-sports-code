...
$this->params['breadcrumbs'][] = ['label' => 'Reward Products', 'url' => ['index']];
                ...
                'attributes' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            return Yii::$app->general->getCategoryName($model->reward_category_id);;
                        },
                    ],
                    'buying_token',
                    [
                        ...
                        'format' => 'html',
                        'value' => function ($model) {
                            return Yii::$app->img->showImage($model->reward_img_url);;
                        },
                    ],
