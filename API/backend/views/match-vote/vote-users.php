...
<div class="d-flex flex-column-fluid">
    ...
    'columns' => [
        ...
        [
            'attribute' => 'id',
            'header' => 'Player Voting',
            'filter' => false,
            'headerOptions' => ['style' => 'width:10%'],
            'format' => 'raw',
            'value' => function ($model) {
                return '<a data-pjax=0 href="' . \yii\helpers\Url::to(['match-vote/index', 'UserMatchVoteSearch[user_id]' => $model->user_id,
                    'UserMatchVoteSearch[match_id]' => $model->match_id]) . '" class="btn btn-primary " title="Voting List">
               Player Votes
            </a>';
            },
        ],
